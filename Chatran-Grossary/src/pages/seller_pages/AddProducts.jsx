  ...
  return (
    ...
    <div className='mt-5 ml-5'>
      ...
      <div className='flex flex-col items-end w-max'>
        <p className='text-2xl font-medium uppercase'>Add Product</p>
      ...
      <div className="no-scrollbar py-10 flex flex-col justify-between bg-white">
        ...
        <form onSubmit={onSubmitHandler} className="md:p-5 p-4 space-y-5 max-w-lg">
          ...
          <button className="px-8 py-2.5 bg-primary-lightgreen text-primary-darkgreen hover:bg-primary-darkgreen hover:text-primary-lightgreen w-full font-medium rounded cursor-pointer">ADD PRODUCT</button>
        </form>
      </div>
    </div>
  )
