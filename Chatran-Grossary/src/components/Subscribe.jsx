...
export default function Example() {
    return (
        ...
        <div className="w-full bg-gray-50 rounded-2xl px-2 text-center text-white py-20 flex flex-col items-center justify-center mt-10">
            ...
            <div className="flex items-center justify-center mt-10 border border-primary-darkgreen focus-within:outline focus-within:outline-indigo-600 text-sm rounded-full h-14 max-w-md w-full">
